...
![A continuación, se presenta el trazado de opciones de registro, informes y supervisión de menos a más complejas, alineadas con vínculos](../../_images/discovery-guides/discovery-guide-logs-and-reporting.png)
...
[Azure Monitor](/azure/azure-monitor/overview) es el servicio de informes y supervisión predeterminado para Azure. Ofrece:
...
- [API REST](/azure/monitoring-and-diagnostics/monitoring-rest-api-walkthrough) para la integración con servicios externos y automatización de los servicios de supervisión y alertas.
- [Integración](/azure/monitoring-and-diagnostics/monitoring-partners) con muchos proveedores externos populares.
