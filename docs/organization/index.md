...
- [Centro de excelencia de la nube](./cloud-center-excellence.md): Mejora de la calidad, velocidad y resistencia de la adopción.
...
Para realizar un seguimiento de las decisiones sobre la estructura de la organización a lo largo del tiempo, descargue y modifique la [plantilla de hoja de cálculo de RACI][template]

> [!div class="nextstepaction"]
> [Descargar la plantilla de hoja de cálculo de RACI][template]
