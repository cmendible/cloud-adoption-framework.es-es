...
En la guía de [convenciones de nomenclatura de recursos de Azure](/azure/architecture/best-practices/naming-conventions) del Centro de arquitectura de Azure se proporcionan recomendaciones generales sobre las convenciones de nomenclatura y se analizan las limitaciones de los nombres y las reglas de plataforma. El siguiente análisis amplía esa guía genérica con recomendaciones más detalladas dirigidas específicamente a respaldar las labores de adopción de la nube empresarial.
